            ...
            <div class="container-fluid h-custom">
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="col-md-10 col-lg-8 col-xl-6 offset-xl-1">
                        ...
                        <form action="{{ route('my-posts.update', $post->slug) }}" method="POST"
                            ...
                            <div class="form-outline mb-3">
                                ...
                                <input name="slug" type="text"
                                    ...
                                    value="{{ old('slug', $post->slug) }}" placeholder="Enter slug category">
                                @error('slug')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-outline mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="text-center mt-3">
                                        <img id="output" src="{{ asset($post->image_url) }}" class="img-fluid"
                            ...
                            <div class="text-center mt-4 pt-2">
                                <button class="btn btn-primary btn-lg"
                                    style="padding-left: 2.5rem; padding-right: 2.5rem;">Cập nhật bài viết</button>
                            </div>
